...
style.textContent =     #block-gs-pillars .sectionHeader, #block-gs-overview .sectionHeader {       display: flex;       align-items: center;       justify-content: space-between;       gap: 12px;       position: relative;     }     .gsHelpWrap {       position: static;       display: inline-flex;       align-items: center;       justify-content: center;       line-height: 1;     }     .gsHelpBtn {       width: 28px;       height: 28px;       border-radius: 50%;       background: #30BA80;       color: #FFFFFF;       border: none;       cursor: pointer;       font-weight: 800;       font-size: 16px;       display: inline-flex;       align-items: center;       justify-content: center;       box-shadow: 0 1px 2px rgba(0,0,0,.06);     }     .gsHelpBtn:focus-visible {       outline: 2px solid #024D4F;       outline-offset: 2px;     }     .gsHelpBubble {       position: absolute;       left: 24px;       right: 0;       top: calc(100% + 8px);       width: auto;       max-width: none;       background: #333333;       border: 1px solid #E5E7EB;       border-radius: 12px;       padding: 12px 14px;       box-shadow: 0 10px 20px rgba(0,0,0,.08), 0 2px 6px rgba(0,0,0,.06);       z-index: 1001;       display: none;     }     .gsHelpBubble p {       margin: 0 0 8px 0;       color: #FFFFFF;       font-size: 14px;       line-height: 1.5;       font-family: 'Inter', sans-serif;     }     .gsHelpBubble p:last-child { margin-bottom: 0; }     .gsHelpWrap:hover .gsHelpBubble,     .gsHelpWrap:has(.gsHelpBtn:focus) .gsHelpBubble {       display: block;     }     .gsHelpWrap.open .gsHelpBubble { display: block; }     #gsOverlay {       position: fixed;       inset: 0;       background: rgba(2, 77, 79, 0.25);       backdrop-filter: blur(2px);       -webkit-backdrop-filter: blur(2px);       z-index: 900;       display: none;     }     #gsOverlay.show { display: block; }     .gsHelpWrap.openHover .gsHelpBubble { display: block; }     #gsOverlay.hover { pointer-events: none; }  ;
document.head.appendChild(style);
}
/* ------------------------------ main render ------------------------------ */
...
contentDiv.innerHTML = `
  <section class="card scrollTarget" id="block-gs-overview">
    ...
    <ol style="padding-left: 20px; margin-top: -4px; margin-bottom: 8px;">
