...
if (allowFull) {
html +=       <div class="card scrollTarget" id="block-positioning">         <div class="sectionTitle">Positioning</div>         ${d.D_SEGMENT ?
Target Segment: ${esc(d.D_SEGMENT)}
: ""} ${d.D_SEGMENT_DESC ?
${esc(d.D_SEGMENT_DESC)}
: ""} ${d.T_CHARACTER ?
Customer Label: ${esc(d.T_CHARACTER)}
: ""} ${d.T_CHARACTER_DESC ?
${esc(d.T_CHARACTER_DESC)}
` : ""} 
